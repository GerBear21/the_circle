      ...
      <div className="cursor-pointer" onClick={onEdit}>
            ...
            return (
              ...
              >
                <svg className={`w-3 h-3 ${fieldConfig.color}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={fieldConfig.icon} />
                </svg>
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-100">
          ...
          <span className="text-xs text-gray-400">
            Updated {new Date(template.updated_at).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' })}
          </span>
        </div>
      </div>
    </Card>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="font-medium text-gray-900">
                  {new Date(template.updated_at).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' })}
                </p>
              </div>
            </div>
          </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl max-w-sm w-full p-6">
        ...
        <p className="text-gray-500 text-center mb-6">
          Are you sure you want to delete &ldquo;<span className="font-medium">{templateName}</span>&rdquo;? This action cannot be undone.
        </p>
        <div className="flex items-center gap-3">
