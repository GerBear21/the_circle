...
const BUILTIN_FORMS = [
    ...
    {
        id: '__hotel_booking_staff',
        name: 'Complimentary Hotel Staff Booking Form',
        description: 'Request complimentary hotel accommodation for staff members.',
    ...
    {
        id: '__hotel_booking_external',
        name: 'External Complimentary Hotel Booking Form',
        description: 'Request complimentary hotel accommodation for external guests and partners.',
        category: 'Travel & Hospitality',
        icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
        color: 'primary',
                                                            ...
                                                            <div className="flex-1 min-w-0">
                                                                ...
                                                                <div className="flex flex-wrap items-center gap-2 mt-4">
                                                                    <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-medium border ${scopeInfo.color}`}>
                                                                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={scopeInfo.icon} />
                                                                        </svg>
                                                                        {scopeInfo.label}
                                                                    </span>
                                                                    {form.category && (
