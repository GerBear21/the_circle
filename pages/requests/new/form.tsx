          ...
          <div className="p-5 space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                ...
                <span className="text-sm font-medium text-gray-800">{approvalDate ? new Date(approvalDate).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' }) : 'Not set'}</span>
              </div>
            </div>
