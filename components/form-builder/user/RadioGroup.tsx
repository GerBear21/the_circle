...
export const RadioGroup = ({ label, options, required }: any) => {
...
export const RadioGroupSettings = () => {
    // Reusing similar settings logic as CheckboxGroup since they heavily overlap in config needs
    const { actions: { setProp }, label, options, required } = useNode((node) => ({
