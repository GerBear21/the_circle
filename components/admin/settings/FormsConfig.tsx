...
export function FormsConfig({ getSetting, queueChange }: ConfigTabProps) {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <Card className="!p-6">
        <CardHeading icon={<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 6h16M4 10h16M4 14h16M4 18h16" /></svg>} iconBg="bg-[#F3EADC]" iconColor="text-[#9A7545]" title="Form Availability & Features" />
